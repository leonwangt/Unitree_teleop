...
class TaskStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('isbusy')) {
        this.isbusy = initObj.isbusy
      }
      else {
        this.isbusy = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [isbusy]
    bufferOffset = _serializer.bool(obj.isbusy, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [isbusy]
    data.isbusy = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.isbusy !== undefined) {
      resolved.isbusy = msg.isbusy;
    }
    else {
      resolved.isbusy = false
    }
