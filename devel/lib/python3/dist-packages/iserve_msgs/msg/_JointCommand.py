...
"""autogenerated by genpy from iserve_msgs/JointCommand.msg. Do not edit."""
import codecs
import sys
...
class JointCommand(genpy.Message):
  _md5sum = "e2a656a20d99d2286fc55f271a447929"
  _type = "iserve_msgs/JointCommand"
...
string frame_id
"""
  __slots__ = ['header','seq','stamp','frame_id','mode','jointNames','position','velocity','acceleration','torque']
  _slot_types = ['std_msgs/Header','uint32','time','string','int32[]','string[]','float64[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,seq,stamp,frame_id,mode,jointNames,position,velocity,acceleration,torque
